...
var Swiper = function (_Component) {
  ...
  _createClass(Swiper, [{
    ...
    value: function _getNormProps(props) {
      return (0, _lodash2.default)(props, _swiperEvents.events.concat(['containerClassName', 'wrapperClassName', 'swiperOptions', 'navigation', 'prevButton', 'nextButton', 'pagination', 'paginationClickable', 'scrollBar', 'onInitSwiper', 'onSwiperUpdated']));
    }
  }, {
    key: '_reInit',
...
Swiper.propTypes = _extends({
  ...
  onSwiperUpdated: _propTypes2.default.func
